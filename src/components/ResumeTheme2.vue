<template>
    <div class="hold_theme2">
        <v-row class="freelancerCard">
            <div class="row">
                <v-container lg="12" md="12" cols="12" class="resumeCardRight">
                    <div class="showOnlyOnmd">
                        <v-row class="headProfile">
                            <v-col lg="2" md="6" class="imageCol">
                            ...
                            <v-col lg="2" md="4" class="freelancerCardLeft">
                                <div class="nameArea">
                                    <div class="nameCard">
                            ...
                            <v-col lg="2" md="4" class="freelancerCardSocial d-flex align-items-center">
                            ...
                            <v-col lg="6" md="8" class="freelancerCardRight">
                                ...
                                <div class="nameArea">
                                    ...
                                    <div class="text-left" style="font-size: 15px; color: white; padding-top: 5px;">
                                        <div class="cardLabel" style="font-weight: 300; font-size:14px ;">Availability :
                                            <span style="font-weight: bold;">{{freelancer.user_data.available_hours_per_week}}h/week</span>
                                        </div>
                                    </div>
                                    <div :id="'welcomeText'+freelancer.id" class="d-none">
                    ...
                    <transition name="slide-fade">
                        <div v-show="portfolio">
                            ...
                            <div id="nav-taps-resume" style="padding-top:2px">                                    
                                <v-tabs v-model="tabber" background-color="transparent" centered align="center">
                                    <v-tab :href="'#languagesTab' + freelancer.id">
                                        Programing Languages
                                    </v-tab>
                                    <v-tab :href="'#databases' + freelancer.id">
                                        Frameworks /<br/>Databases
                                    </v-tab>
                                    <v-tab :href="'#skillsTab' + freelancer.id">
                                        Design Skills
                                    </v-tab>
                                    <v-tab :href="'#software' + freelancer.id">
                                        Software
                                    </v-tab>
                                </v-tabs>
                                    ...
                                    <v-tab-item :value="'languagesTab' + freelancer.id">
                                        <div class="row">
                                            <div class="col-md-12  text-center">
                                                <div class="d-flex items-skills" style="padding-top: 15px;">
                            ...
                            <h3 class="name-section">{{currentTab.name}}</h3>
                        
                        
                            <div v-show="currentTab.name === 'work'">
                                <!-- work section -->
                            ...
                            <div v-show="currentTab.name === 'education'">
                                <!-- education section -->
...
<style lang="scss" scoped>
    ...
    .job-title{
        font-size: 16px;color: #30323D;line-height: 19px;font-weight: bold;
    }
